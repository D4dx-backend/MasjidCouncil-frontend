...
const MedicalAidDataList = ({ onBack, onEdit }) => {
        ...
        <div className="p-8 space-y-8">
          ...
          <section className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="text-sm font-medium text-gray-600">ജമാഅത്തിന്റെ പ്രാദേശിക ഘടകം
                </label>
          ...
          <section className="border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-gray-600">കുടുംബ വലുപ്പം</label>
                  <p className="text-gray-900">{formData.familySize} പേർ</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">ആശ്രിതർ</label>
                  <p className="text-gray-900">{formData.dependents}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-600">പ്രവർത്തന പരിചയം</label>
                  <p className="text-gray-900">{formData.workExperience}</p>
                </div>
              </div> */}
            </div>
          </section>
          ...
          {/* Work History */}
          {/* <section className="border border-gray-200 rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 border-b pb-2">ജോലി ചരിത്രം</h2>
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium text-gray-600">മുമ്പത്തെ ജോലി</label>
                <p className="text-gray-900">{formData.previousEmployment}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600">ഇപ്പോഴത്തെ മസ്ജിദിൽ ജോലി ചെയ്യുന്ന കാലം</label>
                <p className="text-gray-900">{formData.currentWorkDuration}</p>
              </div>
            </div>
          </section> */}
