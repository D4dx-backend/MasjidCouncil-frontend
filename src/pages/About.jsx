...
const About = () => {
  ...
  return (
    <div 
      className="min-h-screen relative bg-cover bg-center bg-no-repeat md:bg-fixed"
      style={{
    ...
    >
      ...
      {/* Main Content */}
      <div className="relative z-20 px-4 sm:px-6 md:px-10 lg:px-14 py-10 sm:py-14 pt-24 sm:pt-28 md:pt-32">
        <div className="max-w-5xl mx-auto">
          <div
            className="space-y-4 text-black leading-relaxed text-justify"
            style={{ fontFamily: "Noto Sans Malayalam" }}
          >
          <h3 className="text-2xl sm:text-3xl font-semibold text-black mb-5 sm:mb-6"
              style={{ fontFamily: "Anek Malayalam Variable" }}
          >
            മസ്ജിദ് കൗൺസിൽ കേരള
          </h3>
          
          <p className="text-sm sm:text-base leading-7 sm:leading-8 font-medium"
             style={{ fontFamily: "Noto Sans Malayalam" }}
          >
          ...
          <h3 className="text-2xl sm:text-3xl font-semibold text-black mb-5 sm:mb-6 mt-10 sm:mt-12"
              style={{ fontFamily: "Anek Malayalam Variable" }}
          >
