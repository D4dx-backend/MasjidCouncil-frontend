...
const MosqueFundList = () => {
  ...
  const handlePrint = async () => {
    ...
    const baseName = `MosqueFund-${formData._id?.slice(-8) || formData._id || 'Application'}`;
  ...
  return (
    ...
    <div className="print-only">
      <div style={printStyles.page}>
        ...
        <div style={printStyles.section} className="print-avoid-break">
          ...
          <table style={printStyles.table}>
            <tbody>
              ...
              <tr>
                <th style={printStyles.th}>മാനേജിംഗ് കമ്മിറ്റി/ട്രസ്റ്റ്</th>
                <td style={printStyles.td}>{safeText(formData.managementType)}</td>
              </tr>
              <tr>
                <th style={printStyles.th}>പ്രസിഡന്റ്/ചെയർമാൻ</th>
                <td style={{ ...printStyles.td, ...rtlValueStyle(formData.presidentSecretary) }}>{safeText(formData.presidentSecretary)}</td>
              </tr>
              <tr>
              ...
              <tr>
                <th style={printStyles.th}>ജമാഅത്തെ ഇസ്‌ലാമി പ്രാദേശിക ഘടകം</th>
                <td style={printStyles.td}>{safeText(formData.jamathIslami)}</td>
              </tr>
              <tr>
        ...
        {/* Previous help / fund collection */}
        <div style={printStyles.section} className="print-avoid-break">
          <p style={printStyles.sectionTitle}>മുമ്പ് സഹായം സംബന്ധിച്ച വിവരങ്ങൾ</p>
          <table style={printStyles.table}>
            <tbody>
              <tr>
                <th style={printStyles.th}>മാസാന്ത ഫണ്ട് ശേഖരണം നടക്കാറുണ്ടോ</th>
                <td style={printStyles.td}>{safeText(formData.mckFundService)}</td>
              </tr>
              <tr>
                <th style={printStyles.th}>മുമ്പ് സഹായം ലഭ്യമായിട്ടുണ്ടോ</th>
        ...
        <div style={printStyles.section}>
          <p style={printStyles.sectionTitle}>നിലവിലെ സഹായം സംബന്ധിച്ച വിവരങ്ങൾ</p>
          <table style={printStyles.table}>
            <tbody>
              <tr>
                <th style={printStyles.th}>സഹായം ആവശ്യമായ ഇനം</th>
            ...
            <tbody>
              <tr>
                ...
                <td style={printStyles.td}>
                  {formData.bankPassbook ? 'Uploaded' : 'Not uploaded'}{'\n'}
                  {formData.bankPassbook ? safeText(formData.bankPassbook, '') : ''}
                </td>
              </tr>
              <tr>
                <th style={printStyles.th}>പദ്ധതി & കണക്ക്</th>
                <td style={printStyles.td}>
                  {formData.fullEstimate ? 'Uploaded' : 'Not uploaded'}{'\n'}
                  {formData.fullEstimate ? safeText(formData.fullEstimate, '') : ''}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        {/* Contact Details */}
        <div style={printStyles.section} className="print-avoid-break">
          <p style={printStyles.sectionTitle}>ബന്ധപ്പെടാനുള്ള വിവരങ്ങൾ</p>
          <table style={printStyles.table}>
            <tbody>
              <tr>
                <th style={printStyles.th}>മസ്ജിദ് ഉദ്യോഗസ്ഥൻ</th>
                <td style={printStyles.td}>
                  പേര്: {safeText(formData.mosqueOfficialName, '-')}{'\n'}
                  ഫോൺ: {safeText(formData.mosqueOfficialPhone, '-')}{'\n'}
                  വാട്സ്ആപ്പ്: {safeText(formData.whatsappNumber, '-')}
                </td>
              </tr>
            </tbody>
          </table>
