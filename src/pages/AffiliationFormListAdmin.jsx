...
const AffiliationFormListAdmin = () => {
  ...
  const currentData = affiliations.slice(startIndex, endIndex);
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead style={{ backgroundColor: '#6db14e' }}>
                    <tr>
                      <th className="px-8 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Affiliation Number</th>
                ...
                <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-700">
                      Showing {startIndex + 1} to {Math.min(endIndex, affiliations.length)} of {affiliations.length} results
                    </div>
